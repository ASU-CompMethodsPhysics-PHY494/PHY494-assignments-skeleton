...
def test_import_module():
    try:
        ...
        raise AssertionError("Cannot import hw09.py module")

def test_import_CrankNicholson_T():
    try:
        from hw09 import CrankNicholson_T
    except ImportError:
        raise AssertionError("Cannot import the hw09.CrankNicholson_T")

def test_import_T_diurnal():
    try:
        from hw09 import T_diurnal
    except ImportError:
        raise AssertionError("Cannot import the hw09.T_diurnal")

class TestTdiurnal(object):
    def setup(self):
        from hw09 import T_diurnal
        t = np.linspace(0, 1.5*24*60*60, 100000)
        self.Temp = T_diurnal(t, Tmin, Tmax, t_max=t_max)
...
class TestCrankNicholson_T(object):
    ...
    def test_left_boundary(self):
        ...
        T_outside = T_diurnal(t, self.Tmin, self.Tmax)
